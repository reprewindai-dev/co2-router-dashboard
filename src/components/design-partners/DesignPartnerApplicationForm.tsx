  ...
  async function handleSubmit(event: FormEvent<HTMLFormElement>) {
    ...
    setError(null)
      ...
      if (!form.commitmentConfirmed || !form.anonymizedProofPermission) {
        setError(
          'The pilot requires a scoped 30-day commitment and permission for anonymized results if it succeeds.'
        )
        return
      }
      ...
      >
        ...
        <div className="mt-6 grid gap-3 text-sm text-slate-300">
          <label className="flex gap-3 rounded-2xl border border-white/8 bg-slate-950/50 px-4 py-3">
            ...
            />
            <span>
              We can commit to a scoped 30-day pilot, one workflow lane, biweekly product
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className="mt-3 text-sm leading-7 text-emerald-50/90">
                  ...
                  champion. If you need to add context immediately, use the live contact path so it
                  lands in the monitored intake inbox.
                </p>
              </div>
            </div>
          </div>
