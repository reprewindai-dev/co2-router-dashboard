export const designPartnerContactEmail = 'intake@co2router.com'

export const designPartnerHeroStats = [
  { value: '3 to 5', label: 'active partners max' },
  { value: '30 days', label: 'pilot term' },
...
export const designPartnerBenefits = [
  ...
  'Hands-on integration support with operator follow-through and founder escalation for priority cases.',
...
export const designPartnerCommitments = [
  'A 30-day paid pilot term with one clearly scoped workflow or workload family.',
...
export const designPartnerTimeline = [
  {
    ...
    title: 'Qualification and setup',
      detail:
      'Confirm ICP fit, lock scope, define success metrics, record the application, and schedule the kickoff path.',
  },
  {
    phase: 'Week 1-2',
    title: 'Activation',
  ...
  },
  {
    ...
    title: 'Iteration',
      detail:
      'Stay inside the agreed scope, refine policies and proof surfaces, and log operational feedback against live usage.',
  },
  {
    phase: 'Week 4',
    title: 'Graduation',
