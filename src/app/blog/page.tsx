...
import { formatBlogPostDate, getPublishedBlogPosts } from '@/lib/blog/posts'
    ...
    <div className="space-y-8 pb-8">
      ...
      <section className="grid gap-4 lg:grid-cols-3">
        {posts.map((post) => (
          ...
          >
            {post.coverImage ? (
              <div className="relative aspect-[16/9] border-b border-white/10 bg-slate-950/70">
                <Image
            ...
            <div className="p-6">
              <div className="flex items-center justify-between gap-3 text-[11px] uppercase tracking-[0.22em] text-slate-500">
                <span>{formatBlogPostDate(post)}</span>
